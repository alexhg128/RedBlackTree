...
JNICALL
Java_com_halexhg_redblacktree_MainActivity_init(
  JNIEnv *env,
  jobject j) {
  //TreeWrapper::init();
  return 1;
...
JNICALL
Java_com_halexhg_redblacktree_MainActivity_insert(
  JNIEnv *env,
  jobject j,
  jint n) {
  //TreeWrapper::
...
extern "C" JNIEXPORT jstring
JNICALL
Java_com_halexhg_redblacktree_MainActivity_delete(
  JNIEnv *env,
  jobject j,
  jint n) {
  tree->Delete(n);
...
extern "C" JNIEXPORT jstring
JNICALL
Java_com_halexhg_redblacktree_MainActivity_print2d(
  JNIEnv *env,
  jobject j,
  jint n) {
  if(n == 1) {
...
extern "C" JNIEXPORT jstring
JNICALL
Java_com_halexhg_redblacktree_MainActivity_printInorder(
  JNIEnv *env,
  jobject j,
  jint n) {
  if(n == 1) {
...
extern "C" JNIEXPORT jstring
JNICALL
Java_com_halexhg_redblacktree_MainActivity_printPreorder(
  JNIEnv *env,
  jobject j,
  jint n) {
  if(n == 1) {
...
extern "C" JNIEXPORT jstring
JNICALL
Java_com_halexhg_redblacktree_MainActivity_printPostorder(
  JNIEnv *env,
  jobject j,
  jint n) {
  if(n == 1) {
